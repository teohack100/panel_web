...
if ($testimonalSlider.length && $.fn.owlCarousel) {
    $testimonalSlider.owlCarousel({
        ...
        items: 1,
        navText: [
            "<img src=\"{$base_url}/firenet/lenzpogi/images/arrow-left.svg\" class=\"dark\"><img src=\"{$base_url}/firenet/lenzpogi/images/arrow-left-black.svg\" class=\"light\">",
            "<img src=\"{$base_url}/firenet/lenzpogi/images/arrow-right.svg\" class=\"dark\"><img src=\"{$base_url}/firenet/lenzpogi/images/arrow-right-black.svg\" class=\"light\">"
        ],
        responsive: {
            0: {
                dots: true,
