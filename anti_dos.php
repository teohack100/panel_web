...
*/
  ...
  $crlf=chr(13).chr(10);
  $itime=20;  // minimum number of seconds between one-visitor visits
  $imaxvisit=20;  // maximum visits in $itime x $imaxvisits seconds
...
//Email Notification. 
  $to      = 'firenetdev@gmail.com';  //Your Admin Email
  $headers = 'From: Possible DDoS Attack. ' . "FeemiumVPN" .   // Set to what you want. 
    		 'X-Mailer: peemeumbeepeeem.cf Is under Attack';
  ...
  $message4='<font color="blue">Overload Warning by FeemiumTeam  Layer 7 Protection</font><br>If you are a human, change IP. <br>We temporarily banned IP <b>'.$_SERVER["REMOTE_ADDR"].' </b>from a possible DoS attack.';
...
//---------------------- End of Basic Config.  ---------------------------------------  
  ...
  if ($newtime>=$time+$itime*$imaxvisit)
  {
    ...
    echo '<html><head><title>Overload Warning by FeemiumTeam  Layer 7 Protection</title></head><body><p align="center"><strong>'
          .$message1.'</strong>'.$br;
