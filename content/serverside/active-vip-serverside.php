...
while( $row = $db->sql_fetchrow($query) ) {
	...
	$vipSeconds = max(0, (int)$row['vip_duration']);
	$dur2 = $db->calc_time($vipSeconds);
	$vipSecondsRemainder = $vipSeconds % 60;
	$dur4 = '<span class="live-countdown" data-seconds="'.$vipSeconds.'">&nbsp;<strong>'.$dur2['days'].'</strong> Day(s) | <strong>'.$dur2['hours'].'</strong> Hour(s) and <strong>'.$dur2['minutes'].'</strong> Minute(s) <strong>'.$vipSecondsRemainder.'</strong> Second(s)</span>';
