...
$serverStatusEmbedUrl = "index.php?p=server-status&embed=admin";
$serverUpdateEmbedUrl = "index.php?p=server-update&embed=admin";
$noticeUpdateEmbedUrl = "index.php?p=notice-update&embed=admin";
