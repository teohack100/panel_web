...
/* Smarty version 3.1.29, created on 2026-03-11 19:13:43
  from "C:\xampp\htdocs\panel_web\templates\js\active-premium-client.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_69b21347cfb481_83736384',
  'file_dependency' => 
  array (
    '99e6707939fb472e4df301e94707d97c774931cb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\panel_web\\templates\\js\\active-premium-client.tpl',
      1 => 1773277848,
      2 => 'file',
    ),
  ),
...
function content_69b21347cfb481_83736384 ($_smarty_tpl) {
?>
...
index.php?p=active-premium-serverside",
            "type": "POST"
        },
		"aoColumnDefs": [{
			'bSortable': false,
...
function add_user(){
	...
	$('#submitRegister').html('Agregar usuario Enviar');
...
{
	alertify.confirm('Do you want to unfreeze and extend this user?',function(e)
	{
		if(e)
		{
			$.ajax({
				type: "POST",
				url: "<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
serverside/freeze/unfreeze2.php",
				data: "uid="+u+"&ucode="+n,
				dataType: "JSON",
				cache: false,
				success: function(data) 
				{
					if(data.response == 1)
					{
						alertify.success('Successfully unfreezed and extended!');
					}else{
						alertify.error("Failed to unfreezed and extend, please try again!");
					}
					reload_table();
					closed();
					displayInActive();
...
function instantCreate(){
	...
	$('.modal-title').text('Generate Trial Accounts');
}
