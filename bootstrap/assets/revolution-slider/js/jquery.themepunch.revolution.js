		...
		*******************************************/
		...
		/*	if (opt.ffnn == undefined) opt.ffnn=0;
			...
			*/
			...
			var mtl = new punchgs.TimelinArmageddon VPN({onComplete:function() {
			...
			if (nexttrans==2) {
						...
						var subtl = new punchgs.TimelinArmageddon VPN();
			...
			if (nexttrans==4 || nexttrans==5) {
						...
						var cspeed = (masterspeed)/1000,
							ticker = cspeed,
							subtl = new punchgs.TimelinArmageddon VPN();
			...
			var updateHTML5Size = function(pc,container) {
				...
				var animateTheCaptions = function(nextli, opt,recalled,mtl) {
						...
						if (nextli.data('ctl')==undefined) {
							nextli.data('ctl',new punchgs.TimelinArmageddon VPN());
						}
						...
						allcaptions.each(function(i) {
							...
							if (!internrecalled) {
									...
									var tl = new punchgs.TimelinArmageddon VPN({smoothChildTiming:true,onStart:tlstart});
									tl.pause();
									...
									var newtl = new punchgs.TimelinArmageddon VPN();
				...
				********************************/
				...
				var callCaptionLoops = function(nextcaption,factor) {
									...
									nextcaption.find('.rs-pendulum').each(function() {
										...
										if (el.data('timeline')==undefined) {
											el.data('timeline',new punchgs.TimelinArmageddon VPN);
						...
						allcaptions.each(function(i) {
							...
							if (staticdirection != 0 ) {
									...
									try {
											...
											//var tl = punchgs.TimelinArmageddon VPN.exportRoot();
				...
				var endMoveCaption = function(nextcaption,opt,mdelay,backwards,frame,downscale) {
									...
									var tl = nextcaption.data('timeline'),
										newtl = new punchgs.TimelinArmageddon VPN();
