             ...
             <div class="left-sidenav">
                <div class="main-icon-menu">
                    <nav class="nav">
                        ...
                        <!--a href="{$base_url}firenet/pages/pages-calendar.html" class="nav-link bg-info shadow-info" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Calendar">                            
                ...
                <div class="main-menu-inner">
                    <div class="menu-body slimscroll">
                        <div id="MetricaAnalytic" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                <li class="nav-item"><a class="nav-link" href="dashboard"><i class="ti-pie-chart"></i>Tablero</a></li>
                                <li class="nav-item"><a class="nav-link" href="my-profile"><i class="ti-id-badge"></i>Mi Perfil</a></li>
                                {if $user_id_2 == 1 || $user_level_2 == 'superadmin' || $user_level_2 == 'subadmin' || $user_level_2 == 'administrator' || $user_level_2 == 'reseller' || $user_level_2 == 'subreseller'}
                                {if $user_id_2 == 1 || $user_level_2 == 'superadmin' || $credits_2 !=0}
                                <li class="nav-item"><a class="nav-link" href="javascript:void(0);" onclick="selfreload()"><i class="ti-calendar"></i>Auto recarga</a></li>
                                {/if}
                                {if $duration_2 > 0 || $vip_duration_2 > 0 || $private_duration_2 > 0}
                        ...
                        <div id="MetricaCrypto" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                <li class="nav-item"><a class="nav-link" href="server-update"><i class="ti-harddrives"></i>Actualización del servidor</a></li>
                                <li class="nav-item"><a class="nav-link" href="notice-update"><i class="ti-pencil-alt"></i>Actualización de aviso</a></li>
                                <li class="nav-item"><a class="nav-link" href="updater-v1"><i class="ti-marker-alt"></i>Updater #1</a></li>
                                <li class="nav-item"><a class="nav-link" href="updater-v2"><i class="ti-marker-alt"></i>Updater #2</a></li>  
                                <li class="nav-item"><a class="nav-link" href="updater-v3"><i class="ti-marker-alt"></i>Updater #3</a></li>
                                <li class="nav-item"><a class="nav-link" href="updater-v4"><i class="ti-marker-alt"></i>Updater #4</a></li>
                            </ul>
                        </div><!-- end Crypto -->
                        <div id="MetricaProject" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                {if $user_id_2 == 1 || $user_level_2 == 'superadmin' || $user_level_2 == 'subadmin' || $user_level_2 == 'administrator' || $user_level_2 == 'reseller' }
                                    {if $user_id_2 == 1}
                                        <li class="nav-item"><a class="nav-link" href="super-administrator"><i class="ti-user"></i>Super Administrador</a></li>
                                    {/if}
                                    {if $user_id_2 == 1 || $user_level_2 == 'superadmin'}
                                        <li class="nav-item"><a class="nav-link" href="administrator"><i class="ti-user"></i>Administrador</a></li>
                                    {/if}
                                    {if $user_id_2 == 1 || $user_level_2 == 'superadmin' || $user_level_2 == 'administrator'}
                                        <li class="nav-item"><a class="nav-link" href="sub-administrator"><i class="ti-user"></i>Sub Administrador</a></li>
                                    {/if}
                                    {if $user_id_2 == 1 || $user_level_2 == 'superadmin'|| $user_level_2 == 'subadmin' || $user_level_2 == 'administrator'}
                                        <li class="nav-item"><a class="nav-link" href="reseller"><i class="ti-user"></i>Reseller</a></li>
                                    {/if}
                                    {if $user_id_2 == 1 || $user_level_2 == 'superadmin' || $user_level_2 == 'subadmin' || $user_level_2 == 'reseller' || $user_level_2 == 'administrator'}
                                        <li class="nav-item"><a class="nav-link" href="sub-reseller"><i class="ti-user"></i>Sub Reseller</a></li>
                                    {/if}
                                {/if}
                            </ul>
                        </div><!-- end  Project-->
                        ...
                        <div id="MetricaCRM" class="main-icon-menu-pane">
                            ...
                            <ul class="nav" id="main_menu_side_nav">
                                ...
                                <li class="nav-item"><a class="nav-link" href="active-premium"><i class="ti-user"></i>Clientes activos</a></li>
                                <li class="nav-item"><a class="nav-link" href="inactive-premium"><i class="ti-user"></i>Clientes inactivos</a></li>
                                <li class="nav-item"><a class="nav-link" href="bulk-premium"><i class="ti-user"></i>Clientes de prueba</a></li>
                                <li class="nav-item"><a class="nav-link" href="freezed-client"><i class="ti-lock"></i>Clientes congelados</a></li>
                                <li class="nav-item"><a class="nav-link" href="deleted-client"><i class="ti-na"></i>Clientes eliminados</a></li>
                            </ul>
                        </div><!-- end CRM -->
                        <div id="MetricaOthers" class="main-icon-menu-pane">
                            ...
                            <ul class="nav metismenu" id="main_menu_side_nav">
                                ...
                                <li class="nav-item"><a class="nav-link" href="server-status"><i class="ti-server"></i>El estado del servidor</a></li>
                                {if $user_id_2 == 1 || $user_level_2 == superadmin || $user_level_2 == administrator}
                                <li class="nav-item"><a class="nav-link" href="online-users-tcp"><i class="ti-layers-alt"></i>Usuarios en línea (TCP)</a></li>
                                <li class="nav-item"><a class="nav-link" href="online-users-udp"><i class="ti-layers-alt"></i>Usuarios en línea (UDP)</a></li>
                                {/if}
                            </ul><!--end nav-->
                        </div><!-- end Others -->
                        ...
                        <div id="MetricaAuthentication" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                <li class="nav-item"><a class="nav-link" href="credit-logs"><i class="ti-book"></i>Registros de crédito</a></li>
                                <li class="nav-item"><a class="nav-link" href="voucher-logs"><i class="ti-agenda"></i>Registros de cupones</a></li>
                            </ul>
