...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Active Private Clients</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Active Client</a></li>
                                        <li class="breadcrumb-item active">Active Private</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Private Clients <span class="badge badge-success">active</span></h4>
...
<!-- jQuery  -->
        ...
        {include file='js/active-private-client.tpl'}
