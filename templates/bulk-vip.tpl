...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - VIP Trial Clients</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">VIP Trial Clients</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">VIP Trial Clients</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">VIP Trial Clients  <span class="badge badge-success">active</span></h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">VIP Trial Clients  <span class="badge badge-danger">inactive</span></h4>
                                    <!--p class="text-muted mb-3">The DataTables API has a number of methods for attaching 
                                        child rows to a parent row in the DataTable. This can be used to show additional 
                                        information about a row, useful for cases where you wish to convey more information 
                                        about a row than there is space for in the host table.
