...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Clientes inactivos</title>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Clientes inactivos</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Clientes inactivos <span class="badge badge-danger">inactive</span></h4>
...
<!-- jQuery  -->
        ...
        {include file='js/inactive-premium-client.tpl'}
