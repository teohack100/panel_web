...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Clientes de prueba</title>
        ...
        <style>
            body #bulk-active-section .card,
            body #bulk-inactive-section .card,
            body #bulk-active-section .card-body,
            body #bulk-inactive-section .card-body,
            body #bulk-active-section .table-responsive,
            body #bulk-inactive-section .table-responsive,
            body #bulk-active-section .btn,
            body #bulk-inactive-section .btn,
            body #bulk-active-section .dataTables_filter input,
            body #bulk-inactive-section .dataTables_filter input,
            body #bulk-active-section .dataTables_paginate .paginate_button,
            body #bulk-inactive-section .dataTables_paginate .paginate_button {
    ...
    <!-- Page Content-->
            <div class="page-content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Clientes de prueba</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Clientes de prueba</h4>
                            </div><!--end page-title-box-->
                        </div><!--end col-->
                    </div>
                    <!-- end page title end breadcrumb -->
                    
                    <div class="row" id="bulk-active-section">
                        <div class="col-12">
                            <div id="success"></div>
                            <div class="card">
                                <form id="delflag_frm" name="delflag_frm">
		                        <input type="hidden" id="submitted_bulk_active" name="submitted" value="Suspend | Delete Submitted">
                                <div class="card-body">
    
                                    <h4 class="mt-0 header-title">Pruebas activas <span class="badge badge-success">activas</span></h4>
                    ...
                    <div class="row" id="bulk-inactive-section" style="display:none;">
                        <div class="col-12">
                            <div id="success2"></div>
                            <div class="card">
                                <form id="frm" name="frm">
		                        <input type="hidden" id="submitted_bulk_inactive" name="submitted" value="Suspend | Delete Submitted">
                                <div class="card-body">
    
                                    <h4 class="mt-0 header-title">Pruebas inactivas <span class="badge badge-danger">inactivas</span></h4>
                                    <!--p class="text-muted mb-3">The DataTables API has a number of methods for attaching 
                                        child rows to a parent row in the DataTable. This can be used to show additional 
                                        information about a row, useful for cases where you wish to convey more information 
                                        about a row than there is space for in the host table.
                                    ...
                                    <div class="btn-group sidebar-social" role="group">
                                      <button id="deleteSubmit2" name="deleteSubmit2" type="button" class="btn btn-danger" onclick="deleteSubmitted2()"><a><i class="fas fa-user-times" aria-hidden="true"></i><span>ELIMINAR</span></a></button>
                                    </div>
                                    <div class="table-responsive">
                                        <table id="users-serverside2" class="table table-striped table-hover table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" class="select-alls" /></th>
                                                    <th>Nombre</th>
                                                    <th>Duracion</th>
                                                    <th>Papel</th>
                                                    <th>Upline</th>
