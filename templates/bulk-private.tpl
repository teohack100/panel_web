...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Private Trial Clients</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="A premium admin dashboard template by Mannatthemes" name="description" />
        <meta content="Mannatthemes" name="author" />

        <!-- App favicon -->
        <link rel="shortcut icon" href="{$base_url}firenet/assets/images/favicon.ico">
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Trial Clients</a></li>
                                        <li class="breadcrumb-item active">Private Trial Clients</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Private Trial Clients</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Private Trial Clients  <span class="badge badge-success">active</span></h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Private Trial Clients  <span class="badge badge-danger">inactive</span></h4>
                                    <!--p class="text-muted mb-3">The DataTables API has a number of methods for attaching 
                                        child rows to a parent row in the DataTable. This can be used to show additional 
                                        information about a row, useful for cases where you wish to convey more information 
                                        about a row than there is space for in the host table.
...
<!-- jQuery  -->
        ...
        {include file='apps/modals-private.tpl'}
        {include file='js/jqueryui_js.tpl'}
        {include file='js/formvalidation_js.tpl'}
        {include file='js/bulk-private-client.tpl'}
