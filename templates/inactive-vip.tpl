...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Inactive VIP Clients</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Inactive VIP</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">VIP Clients</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">VIP Clients <span class="badge badge-danger">inactive</span></h4>
...
<!-- jQuery  -->
        ...
        {include file='js/inactive-vip-client.tpl'}
