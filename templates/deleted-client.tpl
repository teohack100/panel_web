...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Clientes eliminados</title>
...
<body class="monitoring-radius-3">
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Monitoreo de clientes</a></li>
                                        <li class="breadcrumb-item active">Cliente eliminado</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Clientes eliminados</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Clientes eliminados <span class="badge badge-danger">eliminado</span></h4>
                                    ...
                                    <div class="btn-group sidebar-social" role="group">
                                      <button id="recover" alt="recover" type="button" class="btn btn-success" onClick="recover();"><a><i class="fas fa-user-check" aria-hidden="true"></i><span>RECUPERAR</span></a></button>
                                    </div>
                                    <form method="post" id="recovery_frm" name="recovery_frm">
		                            <input type="hidden" id="submitted" name="submitted" value="1">
                                    <div class="table-responsive">
                                        <table id="accountrecovery" class="table table-striped table-hover table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
...
<!-- jQuery  -->
        ...
        {include file='js/deleted-client.tpl'}
