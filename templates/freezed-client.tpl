...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Clientes congelados</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Cliente congelado</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Clientes congelados</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Clientes congelados <span class="badge badge-secondary">congelado</span></h4>
                                    ...
                                    <div class="table-responsive">
                                        <table id="freeze-logss" class="table table-striped table-hover table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
