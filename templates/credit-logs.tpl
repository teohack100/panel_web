...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Historial de créditos</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Historial de créditos</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Historial de créditos</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Historial de créditos</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table id="creditsTbl" class="table table-striped table-hover table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>Nombre</th>
                                                    <th>Movimiento</th>
