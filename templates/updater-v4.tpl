...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Actualizador #4</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Actualizador #4</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Actualizador #4</h4>
                            ...
                            <div class="card">
                                <div class="col-md-12">
            						<form id="GUIFrm" name="GUIFrm" novalidate>
            							<h6>Link: <a class="text-success" href="{$base_url}update-v4" target="_blank">{$base_url}update-v4</a></h6>
            							<hr>
...
<!-- jQuery  -->
        ...
        {include file='js/update_js4.tpl'}
</body>
</html>