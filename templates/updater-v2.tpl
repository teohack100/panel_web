...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Actualizador #2</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Actualizador #2</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Actualizador #2</h4>
                            ...
                            <div class="card">
                                <div class="col-md-12">
            						<form id="GUIFrm" name="GUIFrm" novalidate>
            							<h6>Link: <a class="text-success" href="{$base_url}update-v2" target="_blank">{$base_url}update-v2</a></h6>
            							<hr>
...
<!-- jQuery  -->
        ...
        {include file='js/update_js2.tpl'}
</body>
</html>