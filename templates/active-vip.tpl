...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Active VIP Clients</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Active VIP</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">VIP Clients <span class="badge badge-success">active</span></h4>
