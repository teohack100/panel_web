...
<head>
    ...
    {assign var=pm_index_favicon value="`$base_url`logo/favicon2.png?v=2"}
    {if isset($panel_favicon_url) && $panel_favicon_url neq ''}
        {assign var=pm_index_favicon value=$panel_favicon_url}
    {/if}
    <link rel="shortcut icon" type="image/png" href="{$pm_index_favicon}">
    <title>{$siteTitle} - Página principal</title>
    ...
    <link rel="icon" type="image/png" href="{$pm_index_favicon}">
    <link rel="shortcut icon" type="image/png" href="{$pm_index_favicon}">
    <!-- Google Font -->
    ...
    <!-- Plugins -->
    <link rel="stylesheet" href="{$base_url}/firenet/lenzpogi/css/flipclock.css">
    <link rel="stylesheet" href="{$base_url}/firenet/lenzpogi/css/owl.carousel.min.css">
    <link rel="stylesheet" href="{$base_url}/firenet/lenzpogi/css/owl.theme.default.min.css">
    <!-- Template CSS -->
    <link rel="stylesheet" href="{$base_url}/firenet/lenzpogi/css/light.css">
...
<body class="dark" style="background: #05060A;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: #05060A;">
        <a class="navbar-brand" href="{$base_url}">
            <img src="{$base_url}firenet/assets/images/vicath2.png"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
             ...
             <!--   <li class="nav-item">
                ...
                <li class="nav-item">
                    {* <a class="nav-link" href="https://t.me/dankelthaher">Contacto</a> *}
    ...
    <div class="site-header  d-flex flex-column align-items-center justify-content-between mb-0">
        <div class="hero" style="background: #05060A;">
            ...
            {if $user_id_2 > 0}
            <a href="{$base_url}index.php?p=dashboard" class="btn btn-outline-secondary mt-3">INICIAR SESION
                <img src="{$base_url}/firenet/lenzpogi/images/right-arrow.svg" alt="arrow">
            </a>
            {else}
            <a href="{$base_url}index.php?p=login" class="btn btn-outline-secondary mt-3">INICIAR SESION
                <img src="{$base_url}/firenet/lenzpogi/images/right-arrow.svg" alt="arrow">
            </a>
            {/if}
        </div>
        ...
        <div class="graph">
            <img src="{$base_url}/firenet/lenzpogi/images/graph-dark.svg" alt="graph" class="img-fluid">
        </div>
   ...
   <!-- <section class="section section-highlight" id="news">
                ...
                <div class="col-12 col-md-10">
                    <div class="testimonials mt-lg">
                        <div class="news-slider owl-carousel owl-theme">
                                {foreach item=i from=$downloads} {$i} {/foreach} 
                        </div>
    ...
    <section class="section feature-highlight" id="features">
        <div class="container">
            <div class="section-title mini-title">
                <h4>Elige {$siteTitle}</h4>
            </div>

            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="feature-item">
                        <img src="{$base_url}/firenet/lenzpogi/images/feature-one.svg" alt="icon" class="featured-item-icon">
                ...
                <div class="col-12 col-md-4">
                    <div class="feature-item">
                        <img src="{$base_url}/firenet/lenzpogi/images/feature-two.svg" alt="icon" class="featured-item-icon">
                ...
                <div class="col-12 col-md-4">
                    <div class="feature-item">
                        <img src="{$base_url}/firenet/lenzpogi/images/feature-three.svg" alt="icon" class="featured-item-icon">
    ...
    <section class="section section-highlight discount-fusion">
        <div class="container">
            ...
            <p class="lead p-3 centered-text text-center mx-auto">{$siteTitle} ofrece un descuento único para la cuenta de VPN.</p>
                        ...
                        <div class="testimonial-slider owl-carousel owl-theme">
                            <div class="slider__item">
                                <div class="user-thumbnail">
                                    <img src="{$base_url}/firenet/lenzpogi/images/user-thumb.jpg" alt="user" class="img-fluid">
                                </div>
...
<!--    <section class="section" id="pricing">
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-12 col-md-12 col-lg-4 mb-5">
                    <img src="{$base_url}/firenet/lenzpogi/images/team_1.jpg" alt="team" class="img-fluid mb-4">
                ...
                <div class="col-12 col-md-12 col-lg-4 mb-5">
                    <img src="{$base_url}/firenet/lenzpogi/images/team_4.jpg" alt="team" class="img-fluid mb-4">
                ...
                <div class="col-12 col-md-12 col-lg-4 mb-5">
                    <img src="{$base_url}/firenet/lenzpogi/images/team_3.jpg" alt="team" class="img-fluid mb-4">
                    <a href="https://www.facebook.com/Vicath-VPN-Vic-102768634978393/">
                    <h4 class="mb-0">Nainah Vidal Jacob</h4>
                    <small class="text-light text-uppercase">ADMIN</small>
                    </div>
                <div class="col-12 col-md-12 col-lg-4 mb-5">
                    <img src="{$base_url}/firenet/lenzpogi/images/team_2.jpg" alt="team" class="img-fluid mb-4">
        ...
        <div class="container">
            <div class="footer-minimal-inner">
                <div class="footer-minimal-brand">
                    <img src="{$base_url}firenet/assets/images/vicath2.png" alt="logo-large">
                    <span class="footer-minimal-title">{$siteTitle}</span>
                </div>
                <p class="footer__info--text footer-minimal-text">{$siteTitle} es el activo digital más rápido y escalable, que permite pagos globales en tiempo real en cualquier lugar del mundo.</p>
                <p class="copyright__text mb-0"><small>Copyright ©
                        <script>
                            document.write(new Date().getFullYear());
                        </script>. Todos los Derechos Reservados. {$siteTitle} LLC</small></p>
            </div>
        </div>
        <!-- // container -->
    </footer>
    ...
    <!-- JavaScript -->
    <!-- jQuery & Bootstrap -->
    <script src="{$base_url}/firenet/lenzpogi/js/jquery-3.3.1.slim.min.js"></script>
    <script src="{$base_url}/firenet/lenzpogi/js/bootstrap.bundle.min.js"></script>
    <!-- Plugin JS -->
    <script src="{$base_url}/firenet/lenzpogi/js/plugins/flipclock.min.js"></script>
    <script src="{$base_url}/firenet/lenzpogi/js/plugins/chart.min.js"></script>
    <script src="{$base_url}/firenet/lenzpogi/js/plugins/owl.carousel.min.js"></script>
    <!-- Custom JS -->
    <script src="https://use.fontawesome.com/09c05be15f.js"></script>
    {include file='js/lenz_js.tpl'}
    <script>
