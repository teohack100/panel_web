...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Reseller</title>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Lista de revendedores</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Lista de revendedores</h4>
