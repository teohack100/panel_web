                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Sub-Reseller</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Lista de Sub-Reseller</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Lista de Sub-Reseller</h4>
...
<!-- jQuery  -->
        ...
        {include file='js/sub-reseller.tpl'}
