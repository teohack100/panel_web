	...
	<!-- Content Wrapper. Contains page content -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Server Update</li>
			</ol>
		</section>
					...
					<div class="col-md-12">
						<fieldset class="padding-20">
							...
							<div class="btn-group btn-group-justified" role="group">
								...
								<div class="btn-group" role="group">
									<button class="btn btn-danger" onClick="delete_records();" id="delete_records">
							...
							<form method="post" id="frm" name="frm">
								<div class="panel">
									...
									<table id="servers-serverside" class="table table-striped table-bordered" cellspacing="0" width="100%">
										<thead>
											<tr>
												<th class="text-center"><input type="checkbox" class="select-all" /></th>
												<th class="text-center">Server Name</th>
												<th class="text-center">Server Category</th>
...
$('document').ready(function()
{
	...
	$('#server_frm').formValidation({
		...
		fields: 
		{
			...
			{
				valid: true,
				message: 'The server username is not valid',
				validators: 
				{
                    notEmpty: 
					{
			...
			{
				valid: true,
				message: 'The server password is not valid',
				validators: 
				{
                    notEmpty: 
					{
						message: 'The server password  is required and can\'t be empty'
                    }
				}
			},
//			server_tcp:
