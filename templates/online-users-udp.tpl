...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Usuarios en línea (UDP)</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Gestión del servidor</a></li>
                                        <li class="breadcrumb-item active">Usuarios en línea (UDP)</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Usuarios en línea (UDP)</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Usuarios en línea (UDP)</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table id="onlineusers" class="table table-striped table-hover table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>Nombre</th>
                            						<th>Servidor</th>
...
<!-- jQuery  -->
        ...
        {include file='js/online-stats.tpl'}
