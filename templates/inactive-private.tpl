...
<head>
        <meta charset="utf-8" />
        <title>{$siteTitle} - Inactive Private Clients</title>
                            ...
                            <div class="page-title-box">
                                <div class="float-right">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Inactive Client</a></li>
                                        <li class="breadcrumb-item active">Inactive Private</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Private Clients</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Private Clients <span class="badge badge-danger">inactive</span></h4>
...
<!-- jQuery  -->
        ...
        {include file='js/inactive-private-client.tpl'}
